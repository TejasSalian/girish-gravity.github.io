        ...
        ///////////////// PROJECT PANEL OPEN ///////////////////////
            ...
            function openProjectPanel(bubble){
                ...
                if (click) {
                        ...
                        }).animate({"width":"1050px","left":"206px","z-index":"22"}, "slow"); 
            ...
            $(function () { 
                ...
                $(".closeProject").click(function () {
                    ...
                    if(!click) {
                        ...
                        $("#projectPanel").css('width', function(){ 
                            return $(this).offset().width; 
                        }).animate({"width":"0px","left":"1256px"}, "slow",function(){
                            $(this).toggle();
                            ...
                            $(".innerProjectPanel").css({'width':'50%','margin':'auto'});
                            $(".dataTable").css({'width':'1050px','color':'#000','left':'0'});
                            $(".mainPanel").css({'width':'1050px'});
                            $(".linelst").css({'border-left': 'solid 1px #797979'});
                            $(".circle").css({'background': '#797979'});
            ...
            var conceptCount = 0, strategicCount = 0, preliminaryCount = 0, businessCount = 0, investmentCount = 0, deliveryCount = 0;
            ...
            function jsonLoader() {
                ...
                $.getJSON(url1_temp, function(data) {
                    ...
                    $('<tbody/>',{html:items.join("")}).appendTo($(".dataTable"));
                    $('.stagelst').show();
                    $('.valuelst').show();
                    $('.regionlst').show();
                    $('.assetclasslst').show();
                ...
                $.getJSON(url2_temp, function(data) {
                    ...
                    // MAIN STUFF
                        ...
                        if(projectStage.toUpperCase() == 'Delivery'.toUpperCase()) {
                            ...
                            $(".pI_regionDetails").css({"margin-top":"270px","position":"absolute"});
                            ...
                            // $(".pI_regionImg").attr('src',setImage(jsonData[id].RegionName));
                            $(".pI_assetClassDetails").css({"margin-top":"270px","left":"620px","width":"100%","position":"absolute"});
                            ...
                            $(".pI_regionDetails").css({"margin-top":"50px","position":"relative"});
                            ...
                            $(".pI_assetClassDetails").css({"margin-top":"-130px","left":"620px","width":"100%","position":"relative"});
                            $(".pI_regionName").text(jsonData[id].RegionName);
                            // $(".pI_regionImg").attr('src',jsonData[id].RegionImg);
                            if(setImage(jsonData[id].RegionName) != '')
                            {
    ...
    $('a.less', minimized_elements).click(function(event){
        ...
        $(this).parent().hide().prev().show().prev().show();    
            ...
            $(".dataTable").on('click',"tbody tr",function(){
                ...
                $(".dataTable").css({'color':'#fff','position': 'relative'});
                $(".mainPanel").css({'width':'100%'});
                $(".linelst").css({'border-left': 'solid 1px #fff'});
                ...
                $(".innerProjectPanel").css({'width':'0px','margin-left':'20px'});
            ...
            $('.backBtn').click(function(){
                ...
                $(".dataTable").css({'color':'#000','width':'1050px','left':'0'});
                $(".mainPanel").css({'width':'1050px'});
                $(".overviewlst").show();
                $(".valuelst").show();
                $(".stagelst").show();
...
$(".scrollIndicator").click(function(event){
     $('#canvasContainer').animate({
        scrollTop: $("#canvasContainer").height()}, 1000);
});
...
$(".floatDropPanel").on('click',function(){
    ...
    if(!floatOpen){
        ...
        $(".floatDropDown").animate({
            ...
            $(this).css({"box-shadow":" 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 3px 10px 0 rgba(0, 0, 0, 0.19)"});
        });
        floatOpen = true;
    }
    else{
        $(".floatDropDown").css({"box-shadow":"none"});
        $(".floatDropDown").animate({
            "top":"70px"
        });
...
$('#q_year').on('change', function() {
    if (this.value === String('2017')){
        $('.year-wise').css({'display' : 'none'});
    }else if (this.value === String('2018')){
        $('.year-wise').css({'display' : 'block'});
        init();
    }
});